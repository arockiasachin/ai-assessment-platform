...
export function FuturePagePlaceholder({ role, pageName }: { role: "student" | "teacher"; pageName: string }) {
  return (
    <Card className="border-primary/20 bg-gradient-to-br from-primary/10 via-background to-background shadow-sm">
      <CardHeader>
        ...
        <CardTitle className="text-base tracking-tight">{pageName} is ready for future implementation</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3 text-sm text-muted-foreground">
        <p>
          This is a scaffold page connected from the collapsible right menu.
          You can add the full feature implementation here later.
        </p>
        <Link
