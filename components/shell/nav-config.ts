  ...
  teacher: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          // Real page only: the support desk is a separate application, and
          // there is no mockup surface it corresponds to.
          label: "Help",
          href: "/help",
          icon: LifeBuoy,
          description: "Report a problem or ask a question; track the tickets you have filed.",
          appOnly: true,
        },
      ],
    },
