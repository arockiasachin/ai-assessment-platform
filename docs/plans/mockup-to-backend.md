...
| **Two Wave 1 rows are wrong**                 | `teacher/classes` is a different screen (offering admin vs roster), and `teacher/submissions` has no real page at all. Both need a decision.                                                                                           | See [`wave-1.md`](./wave-1.md) §1 and §4 (D1, D2).                                                                                                                                  |
